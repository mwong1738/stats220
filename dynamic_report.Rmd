...
The minimum time spent on a social media app was `r min_time_used` minutes, the mean time was `r mean_time_used` minutes and the maximum time was `r mean_time_used` minutes.
